        ...
        <Container maxWidth="lg" sx={{ py: 8, mt: 8 }}>
          <motion.div variants={fadeIn} initial="hidden" animate="visible">
            <Box sx={{ textAlign: 'center', py: 8 }}>
              ...
              >
                Looks like you haven't added any plants to your cart yet. Browse our collection and
                  ...
                  >
                    <CardContent>
                      ...
                      <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
                        Proceed to enter your shipping and payment information to complete your
                        order.
                      </Typography>
                      <Button
                        variant="contained"
                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                      <Box sx={{ display: 'flex', gap: 2, justifyContent: 'space-between', mt: 4 }}>
                        <Button onClick={handleBack} variant="outlined" size="large" sx={{ px: 4 }}>
                          Back
                        </Button>
                        <Button
                          type="submit"
          ...
          {activeStep === 2 && (
            <motion.div variants={fadeIn}>
              ...
              >
                ...
                <CircularProgress size={40} thickness={4} sx={{ color: 'success.main', mb: 3 }} />
                <Typography variant="body2" color="text.secondary">
